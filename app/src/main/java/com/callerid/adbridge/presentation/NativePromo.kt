...
import com.callerid.adbridge.data.AdKind.*
import com.callerid.adbridge.domain.AdCounterRegistry.nativeCounter
...
import com.callerid.numberlookup.home.databinding.FbMidNativeBinding
import com.callerid.numberlookup.home.databinding.FbNativeBinding
import com.callerid.numberlookup.home.databinding.GooglebignativeBinding
import com.callerid.numberlookup.home.databinding.GooglebignativetopBinding
import com.callerid.numberlookup.home.databinding.Googlemidnative2Binding
import com.callerid.numberlookup.home.databinding.GooglemidnativeBinding
...
class NativePromo() {
    ...
    fun loadNativeADs(context: Activity, observer: NativeAdObserver? = null) {
        ...
        if (!adsPreference.getBoolean("IsAdsON") || AdKind.fromString(adsPreference.getString("IsAdType")) != AdKind.GOOGLE) {
    ...
    fun showBigNative(
        ...
        // 🔥 2. Network + Ads ON + NativePromoBanner master switch
                    ...
                    try {
                        ...
                        if (nativeAd != null) {
                            ...
                            if (BuildConfig.DEBUG) {
                                AdRevenueMeter.simulateDebugRevenue(context)
                            }
                        ...
                        if (adsPreference.getBoolean("IsFail_FB")) {
                            showFBNativeFallback(context, layout, imageView, shimmer)
                        } else {
                            layout.removeAllViews()
                            shimmer?.stopShimmer()
                            shimmer?.isVisible = false
                            ...
                            CustomAdsRegistry().loadCustomAd(
                                context,
                                layout,
                                CustomAdsRegistry.CustomAdType.BIG_NATIVE,
                                imageView
                            )
                        }
    ...
    private fun showFBNativeFallback(
        context: Activity,
        layout: FrameLayout,
        imageView: ImageView? = null,
        shimmer: ShimmerFrameLayout? = null
    ...
    fun inflateFbNativeAd(
        ...
        val txtColor =
            AdsVault.getInstance(activity).getString("NativetxtColor") ?: "#000000"
        val btntxtColor =
...
//================================================================================MidNAtive
    fun showMidNative(
        ...
        // Check network & ad toggle + NativePromoBanner master switch
        if (!isNetworkConnected(context)
                    ...
                    try {
                        ...
                        if (adsPref.getBoolean("IsFail_FB")) {
                            ...
                            CustomAdsRegistry().loadCustomAd(
                                context,
                                layout,
                                CustomAdsRegistry.CustomAdType.MID_NATIVE
                            )
                        }
                    } catch (e: Exception) {
            ...
            fbNative.buildLoadAdConfig().withAdListener(object : NativeAdListener {
                override fun onMediaDownloaded(ad: Ad?) {
                    ...
                    layout.post {
                        ...
                        shimmer?.stopShimmer()
                        shimmer?.isVisible = false
                        inflateFbMidNativeAd(fbNative, layout, context)
