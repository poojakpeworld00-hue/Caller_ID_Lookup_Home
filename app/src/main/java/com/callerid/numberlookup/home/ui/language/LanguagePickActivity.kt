package com.callerid.numberlookup.home.ui.language
...
import com.callerid.numberlookup.home.databinding.ActivityLanguageBinding
...
import com.callerid.numberlookup.home.permission.fsi.FsiGateActivity
import com.callerid.numberlookup.home.ui.AppHubActivity
import com.callerid.numberlookup.home.ui.intro.IntroRevealConfig
...
class LanguagePickActivity : ScreenBaseActivity<ActivityLanguageBinding>() {
    ...
    override fun initView() {
        ...
        // Current language comes from AppVault (the store ScreenBaseActivity.applyLocale reads).
        ...
        // through to ScreenBaseActivity's exit handler; `forwarding` blocks re-entry.
    ...
    private fun detectCountryByIp() {
        lifecycleScope.launch {
            val geo = RegionLocator.detectCountry(this@LanguagePickActivity) ?: run {
    ...
    private fun onContinue() {
        ...
        AppVault.setLanguage(this, tag)  // source of truth for Splash + ScreenBaseActivity.applyLocale
    ...
    companion object {
        private const val TAG = "LanguagePickActivity"
        ...
        fun newIntent(context: Context, standalone: Boolean = false): Intent =
            Intent(context, LanguagePickActivity::class.java)
