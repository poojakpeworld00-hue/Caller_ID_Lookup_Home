...
import com.callerid.numberlookup.home.launcher.helpers.MIN_COLUMN_COUNT
import com.callerid.numberlookup.home.launcher.helpers.MIN_ROW_COUNT
...
class DeckSettingsActivity : CoreDeckActivity() {
    ...
    private fun setupCustomizeColors() {
        binding.settingsColorCustomizationHolder.setOnClickListener {
            // see CoreDeckActivity.withFossifyPackageNameSpoofed — startCustomizationActivity()
