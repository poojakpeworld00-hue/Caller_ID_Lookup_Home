...
import com.callerid.numberlookup.home.ui.tools.SimDeckActivity
...
class OptionsDeckActivity : ScreenBaseActivity<ActivitySettingsBinding>() {
    ...
    override fun initView() {
        ...
        // Native ad at the top of the settings list (bottom adaptive banner auto-loads via ScreenBaseActivity).
        ...
        bindCard(
            ...
            openActivity(LanguagePickActivity.newIntent(this, standalone = true))
        }
        bindCard(
            ...
            openActivity<BlockLedgerActivity>()
        }
        bindCard(
    ...
    private fun openSimManagement() {
        ...
        if (!opened) openActivity<SimDeckActivity>()
    }
            ...
            cell.setOnClickListener {
                ...
                if (theme != AppVault.selectedTheme(this)) {
                    AppVault.setTheme(
                        this,
                        theme
                    )              // store ScreenBaseActivity.applyTheme reads
