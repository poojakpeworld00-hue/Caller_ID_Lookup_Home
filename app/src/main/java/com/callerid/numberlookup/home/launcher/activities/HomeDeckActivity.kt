...
import com.callerid.numberlookup.home.launcher.extensions.getLabel
import com.callerid.numberlookup.home.launcher.extensions.handleGridItemPopupMenu
...
import com.callerid.numberlookup.home.launcher.extensions.launchAppInfo
import com.callerid.numberlookup.home.launcher.extensions.launchersDB
import com.callerid.numberlookup.home.launcher.extensions.requestSetAsDefaultLauncher
import com.callerid.numberlookup.home.launcher.extensions.supportsDarkText
import com.callerid.numberlookup.home.launcher.extensions.uninstallApp
import com.callerid.numberlookup.home.launcher.fragments.MyFragment
import com.callerid.numberlookup.home.launcher.helpers.CLOCK_ROW_SPAN
...
import com.callerid.numberlookup.home.launcher.helpers.ITEM_TYPE_SHORTCUT
...
import com.callerid.numberlookup.home.launcher.helpers.IconCache
import com.callerid.numberlookup.home.launcher.helpers.PSEUDO_WIDGET_CLOCK
import com.callerid.numberlookup.home.launcher.helpers.PSEUDO_WIDGET_SEARCH
import com.callerid.numberlookup.home.launcher.helpers.REQUEST_ALLOW_BINDING_WIDGET
import com.callerid.numberlookup.home.launcher.helpers.SEARCH_BAR_ROW
import com.callerid.numberlookup.home.launcher.helpers.REQUEST_CONFIGURE_WIDGET
import com.callerid.numberlookup.home.launcher.helpers.REQUEST_CREATE_SHORTCUT
import com.callerid.numberlookup.home.launcher.helpers.UNINSTALL_APP_REQUEST_CODE
import com.callerid.numberlookup.home.launcher.interfaces.FlingListener
...
import com.callerid.numberlookup.home.launcher.receivers.LockDeviceAdminReceiver
...
class HomeDeckActivity : CoreDeckActivity(), FlingListener, HomeShellHost {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // language's resources. ScreenBaseActivity does this for every other screen; this one does
        ...
        // native-ad palette keys are global, only ever written by ScreenBaseActivity, which this is
        ...
        binding.leftPanel.root.apply {
            setupFragment(this@HomeDeckActivity)
    ...
    override fun onResume() {
        ...
        // onboarding picker both live in other Activities). Same call ScreenBaseActivity makes here.
        LocaleRegistry.applySaved(this)
        ...
        ensureBackgroundThread {
            ...
            binding.leftPanel.root.gotLaunchers(IconCache.launchers)
            refreshLaunchers()
        }
    ...
    private fun launchSettings() {
        startActivity(
            Intent(this@HomeDeckActivity, DeckSettingsActivity::class.java)
        )
    }
    ...
    private class MyGestureListener(
        ...
        override fun onSingleTapUp(event: MotionEvent): Boolean {
            (flingListener as HomeDeckActivity).homeScreenClicked(event.x, event.y)
            return super.onSingleTapUp(event)
        }

        override fun onDoubleTap(event: MotionEvent): Boolean {
            (flingListener as HomeDeckActivity).homeScreenDoubleTapped(event.x, event.y)
        ...
        override fun onLongPress(event: MotionEvent) {
            (flingListener as HomeDeckActivity).homeScreenLongPressed(event.x, event.y)
        }
    }
    ...
    private fun seedHomeWidgetsIfNeeded() {
        ...
        try {
            ...
            Log.e("HomeDeckActivity", "Failed to seed default home widgets", e)
        }
    }
