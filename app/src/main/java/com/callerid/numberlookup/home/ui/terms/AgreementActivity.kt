...
class AgreementActivity : ScreenBaseActivity<ScreenTermsBinding>() {
    ...
    override fun initView() {
        ...
        // enabled so back never falls through to ScreenBaseActivity's exit handler;
    ...
    private fun proceedToNextScreen() {
        ...
        val next = if (IntroRevealPolicy.shouldShowOnboarding(this)) TourActivity::class.java
