...
import com.callerid.numberlookup.home.launcher.helpers.REPOSITORY_NAME

open class CoreDeckActivity : BaseSimpleActivity() {
     ...
     * (com.callerid.numberlookup.home), not the unauthorized clone that check is meant to catch, so
