...
class AppHubActivity : ScreenBaseActivity<ScreenMainBinding>(), HomeShellHost {
    ...
    override fun initView() {
        ...
        // back leaves for the launcher home. Registered here — after ScreenBaseActivity's back-ad
    ...
    /**
     * Reorders the EXISTING AppHubActivity to the front of the same task, so a (NO_HISTORY)
